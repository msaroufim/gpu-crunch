...
export const CARDS: Card[] = [
  ...
  c('jensen-soju-toast', 'Soju Toast With Memory Vendors', 'Market', 1, 'early', 'A private dinner turns into another HBM allocation before rivals know the guest list.', { influence: 2, money: 1 }, { influence: 1, compute: 1 }, undefined, { policy: 1, moat: 1 }, 2, 'toast', 'shock'),
  ...
  c('blackwell-ramp', 'Blackwell Demand Moons', 'Silicon', 3, 'late', 'The flagship finally ships, allocation vanishes, and every forecast line goes vertical.', { compute: 6 }, { compute: 4 }, { compute: 2 }, { capacity: 5, moat: 2 }, 7, 'fab', 'priority'),
  ...
  c('tariff-arbitrage', 'Use Tariffs As A Moat', 'Policy', 2, 'mid', 'The route is longer, the invoice is cleaner, and rivals eat the delay.', { money: 2, influence: 2 }, { money: 2 }, undefined, { policy: 2, moat: 1 }, 2, 'policy', 'shock'),
