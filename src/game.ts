...
export const CARDS: Card[] = [
  ...
  c('substrate-supplier', 'Substrate Supplier', 'Fabrication', 1, 'early', 'The unglamorous layer that saves the quarter.', { money: 1 }, { money: 2, compute: 1 }, { money: 1 }, { capacity: 1 }, 1, 'package', 'decoy'),
  ...
  c('cloud-preorder', 'Cloud Preorder', 'Demand', 1, 'early', 'Capacity booked before the rack exists.', { money: 2, compute: 1 }, { money: 3 }, { money: 1 }, { moat: 1, capacity: 1 }, 1, 'cloud', 'decoy'),
  ...
  c('hopper-fire-sale', 'Hopper Fire Sale', 'Market', 1, 'early', 'Last generation still trains this generation.', { money: 1 }, { compute: 2 }, undefined, { capacity: 1 }, 1, 'market', 'decoy'),
  ...
  c('dram-price-spike', 'DRAM Price Spike', 'Memory', 2, 'mid', 'A bad quarter for buyers, a great quarter for you.', { money: 2, influence: 1 }, { money: 3 }, undefined, { moat: 2 }, 2, 'memory', 'decoy'),
  ...
  c('startup-allocation-lottery', 'Startup Allocation Lottery', 'Demand', 1, 'early', 'You won four boards and a cloud credit coupon.', { influence: 1, money: 1 }, { compute: 2, money: 1 }, undefined, { moat: 1 }, 1, 'cloud', 'decoy'),
  ...
  c('power-cap-firmware', 'Power Cap Firmware', 'Energy', 1, 'early', 'Less clock, more cluster.', { compute: 1 }, { energy: 2 }, { energy: 1 }, { grid: 2 }, 1, 'power', 'decoy'),
