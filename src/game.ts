...
export const CARDS: Card[] = [
  ...
  c('hbm-allocation', 'HBM Allocation', 'Memory', 1, 'early', 'The memory vendor finally returns your call.', { money: 2 }, { compute: 1 }, { compute: 1 }, { capacity: 1, moat: 1 }, 0, 'memory'),
  ...
  c('substrate-supplier', 'Substrate Supplier', 'Fabrication', 1, 'early', 'The unglamorous layer that saves the quarter.', {}, { money: 1, compute: 1 }, { money: 1 }, { capacity: 1 }, 0, 'package', undefined, true),
  ...
  c('cloud-preorder', 'Cloud Preorder', 'Demand', 1, 'early', 'Capacity booked before the rack exists.', { money: 2, compute: 1 }, { money: 3 }, { money: 1 }, { moat: 1, capacity: 1 }, 0, 'cloud', 'priority'),
  ...
  c('earthquake-insurance', 'Foundry Earthquake Insurance', 'Risk', 1, 'early', 'You cannot stop the quake, but you can buy resilience.', {}, { influence: 1 }, { money: 1 }, { policy: 1, capacity: 1 }, 0, 'risk', undefined, true),
  ...
  c('firmware-miracle', 'Firmware Miracle', 'Software', 1, 'early', 'The same silicon gets a better story.', {}, { compute: 1, energy: 1 }, { energy: 1 }, { moat: 1 }, 0, 'software', undefined, true),
  ...
  c('power-cap-firmware', 'Power Cap Firmware', 'Energy', 1, 'early', 'Less clock, more cluster.', { compute: 1 }, { energy: 2 }, { energy: 1 }, { grid: 2 }, 0, 'power'),
  ...
  c('water-permit', 'Water Permit', 'Energy', 1, 'early', 'Cooling begins at the county office.', {}, { energy: 1 }, { influence: 1 }, { grid: 1, policy: 1 }, 0, 'cooling', undefined, true),
