...
export const EVENTS: EventCard[] = [
  { id: 'taiwan-war-games', name: 'Taiwan War Games', headline: 'Everyone remembers where the wafers come from.', rule: 'Compute costs +1.', costMod: { compute: 1 } },
  ...
  { id: 'anti-ai-protests', name: 'Anti-AI Protest', headline: 'The zoning hearing becomes a livestream.', rule: 'Energy costs +1.', costMod: { energy: 1 } },
  { id: 'election-shock', name: 'Election Shock', headline: 'Every permit, tariff, and subsidy is suddenly negotiable.', rule: 'Influence costs +1. Gain +1 Money.', costMod: { influence: 1 }, incomeMod: { money: 1 } },
  { id: 'chips-grants', name: 'CHIPS Grant Blitz', headline: 'Subsidy paperwork becomes alpha.', rule: 'Money costs -1. Gain +1 Influence.', costMod: { money: -1 }, incomeMod: { influence: 1 } },
  ...
  { id: 'power-spike', name: 'Power Price Spike', headline: 'The marginal megawatt gets ugly.', rule: 'Energy budget -1.', incomeMod: { energy: -1 } },
  { id: 'benchmark-panic', name: 'Benchmark Panic', headline: 'One chart makes every cluster obsolete.', rule: 'Gain +1 Compute.', incomeMod: { compute: 1 } },
  { id: 'export-controls', name: 'Export Controls', headline: 'Legal review hits every shipment.', rule: 'Influence costs +1. Gain +1 Influence.', costMod: { influence: 1 }, incomeMod: { influence: 1 } },
  { id: 'foundry-quake', name: 'Foundry Quake', headline: 'Buffer inventory stops looking wasteful.', rule: 'Money costs +1. Gain +1 Influence.', costMod: { money: 1 }, incomeMod: { influence: 1 } },
  { id: 'capex-freeze', name: 'Capex Freeze', headline: 'Cloud CFOs discover discipline.', rule: 'Money budget -1.', incomeMod: { money: -1 } },
  { id: 'shipping-backlog', name: 'Shipping Backlog', headline: 'The GPUs exist. The trucks do not.', rule: 'Money costs +1. Gain +1 Energy.', costMod: { money: 1 }, incomeMod: { energy: 1 } },
  ...
  { id: 'engineer-poaching-war', name: 'Engineer Poaching War', headline: 'Every distinguished engineer gets three calls before lunch.', rule: 'Influence costs +1. Compute costs -1.', costMod: { influence: 1, compute: -1 } },
  { id: 'gray-market-crackdown', name: 'Gray-Market Crackdown', headline: 'A freight forwarder gets too famous.', rule: 'Money costs +1. Compute costs +1.', costMod: { money: 1, compute: 1 } },
